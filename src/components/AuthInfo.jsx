...
const FEATURES = [
  ...
  { emoji: "🎨", label: "Mascots & themes", blurb: "Pick a buddy and a vibe — sakura, matcha, candlelit scholar, and more." },
];
...
const FAQS = [
  ...
  },
  {
    ...
    a: "Settings → Export gives you a full JSON backup anytime, no asking needed. Want your account wiped instead? Just reach out to me and I'll delete it by hand.",
  },
  {
  ...
  return (
    <div className="sb-auth-info">
      <div className="sb-auth-info-hero">
        <Mascot species="bunny" mood="happy" size={56} />
        <div>
      ...
      <div className="sb-auth-features">
        {FEATURES.map((f) => (
          <div className="sb-auth-feature" key={f.label}>
