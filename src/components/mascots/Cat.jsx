...
function Eye({ state, pupil, mirror }) {
  ...
  if (state === "closed") {
    return <path d={`M ${-6 * flip} 1 Q 0 ${-5} ${6 * flip} 1`} stroke="var(--figure-ink)" strokeWidth="2.1" fill="none" strokeLinecap="round" />;
  }
  if (state === "heavy") {
    return (
      <>
        <path d={`M ${-6 * flip} -1 Q 0 -4 ${6 * flip} -1`} fill="none" stroke="var(--figure-ink)" strokeWidth="1.3" opacity="0.55" />
        <path d={`M ${-5.5 * flip} 1 Q 0 2.6 ${5.5 * flip} 1`} fill="none" stroke="var(--figure-ink)" strokeWidth="2" strokeLinecap="round" />
      </>
    );
  }
  ...
  return (
    <>
      <path
        ...
        fill="var(--figure-body)" stroke="var(--figure-ink)" strokeWidth="1.2"
      />
      <ellipse cx={-1.6 * flip} cy={dy} rx="1.7" ry={pupil} fill="var(--figure-ink)" />
  ...
  return (
    <svg width={size} height={size} viewBox="-42 -50 84 92" style={{ overflow: "visible", flexShrink: 0 }}
      ...
      <g className="sb-ear sb-ear-l" style={{ transform: m.earsBack ? "rotate(-32deg) translate(3px,4px)" : "none" }}>
        ...
        <path d="M -19 -19 L -13 -29 L -8 -18 Z" fill="var(--figure-inner)" />
      </g>
      ...
      <path d="M -2.6 1 L 2.6 1 L 0 4.5 Z" fill="var(--figure-inner)" stroke="var(--figure-outline)" strokeWidth="1" strokeLinejoin="round" />
      ...
      <path d={m.mouth} stroke="var(--figure-ink)" strokeWidth="2" fill="none" strokeLinecap="round" transform="translate(0,3)" />

      {/* whiskers, always on top */}
      <path d="M -6 6 L -18 3" stroke="var(--figure-ink)" strokeWidth="1.3" strokeLinecap="round" />
      <path d="M -6 9 L -18 10" stroke="var(--figure-ink)" strokeWidth="1.3" strokeLinecap="round" />
      <path d="M 6 6 L 18 3" stroke="var(--figure-ink)" strokeWidth="1.3" strokeLinecap="round" />
      <path d="M 6 9 L 18 10" stroke="var(--figure-ink)" strokeWidth="1.3" strokeLinecap="round" />

      {m.glasses && (
        <g transform="translate(0,-3)" stroke="var(--figure-outline)" strokeWidth="1.6" fill="none">
      ...
      {m.paw && (
        <ellipse cx="-16" cy="12" rx="6" ry="5" fill="var(--figure-inner)" stroke="var(--figure-outline)" strokeWidth="1.4" transform="rotate(-18 -16 12)" />
      )}
